...
// Los estilos están SIEMPRE montados, tanto en modal como inline
const SETTINGS_STYLES = `
  ...
  .settings-card {
    ...
    animation: s-slideUp 0.2s ease; overflow: hidden;
  ...
  .settings-wrap.inline { flex-direction: column; height: 100%; }
  ...
  .settings-wrap.inline .settings-nav {
    ...
    border-bottom: 1.5px solid var(--border); padding: 8px 10px;
    gap: 4px; flex-shrink: 0; flex-wrap: wrap;
  ...
  .settings-wrap.inline .settings-content { padding: 16px 14px; flex: 1; min-height: 0; }
  ...
  @media (max-width: 540px) {
    ...
    .settings-wrap.inline .settings-nav { padding: 6px 8px; gap: 4px; }
    /* En móvil el nav es grid 4 columnas, los items son pequeños y centrados */
    .settings-wrap.inline .s-nav-item {
      padding: 8px 4px; font-size: 0.72rem;
      flex-direction: column; gap: 3px;
      justify-content: center; align-items: center;
      text-align: center;
    }
    .settings-wrap.inline .s-nav-item svg { width: 17px; height: 17px; }
  }
`;

export default function SettingsModal({ onClose, inline, propagateName }) {
  ...
  const handleSaveName = async () => {
    ...
    try {
      await updateUserName(displayName.trim(), propagateName);
      setSaveStatus("saved");
        ...
        <div className="settings-content">
          ...
          {activeSection === "profile" && (
            <div className="s-section">
              ...
              <p className="s-desc">Este nombre aparece en tus citas y en los grupos.</p>
          ...
          {activeSection === "about" && (
            <div className="s-section">
              ...
              <div className="about-logo">
                ...
                <div className="about-app-name">Naiana</div>
              ...
              <div className="copyright">
                ...
                <span>Hecho con ❤️ para Naiana</span>
              </div>
            </div>
          )}
        </div>
